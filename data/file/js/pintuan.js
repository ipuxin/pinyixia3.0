...
var Pintuan = {
	...
	printDuobaoProduct:function(list){
		for(var i in list){
			...
			var line2 = $('<tit>'+pro.ProductName+'</tit>');
			line2.append('<i class="hot"></i>');
			var line3 = $('<p><teaminfo>'+pro.TeamMemberLimit+'人团 | <r>'+pro.SalesCountReal+'</r>人已申请</teaminfo><price>价值<r>¥'+pro.Prices.Normal+'</r><m>限量 '+pro.StorageCount+' 件</m></price><btn class="rbtn page" data-page="/product/info/'+pro.ProductId+'">立即抢夺</btn></p>');
			box.append(line1);
			box.append(line2);
			box.append(line3);
			$('ul.cateprolist').append(box);
