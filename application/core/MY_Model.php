...
class MY_Model extends CI_Model
{
    ...
    function setUserInfo()
    {
        ...
        if (!$this->_member_nickName) {
            $this->_member_nickName = '游客';
        }
        if (!$this->_member_headimgurl) {
            $this->_member_headimgurl = $this->config->item('static_file_path') . "images/user.png";
        }
    }
